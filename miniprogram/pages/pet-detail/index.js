...
Page({
  ...
  normalizePet(item = {}) {
    ...
    return {
      ...
      socialEntryLabel: isInStars ? '回忆动态' : '朋友圈',
      ...
      avatar: item.avatarUrl || item.avatar || item.coverUrl || item.cover || defaultPetImage,
      cover: themeBackgrounds[item.theme] || item.coverUrl || item.cover || item.avatarUrl || item.avatar || defaultPetImage,
