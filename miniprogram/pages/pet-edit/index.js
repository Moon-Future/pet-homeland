...
Page({
  ...
  fillForm(pet = {}) {
    ...
    const lifeStatus = pet.lifeStatus || 'with_me'
    const selectedTheme = storage.resolveThemeForLifeStatus(pet.theme, lifeStatus)
    this.setData({
      themes: storage.getThemeOptionsForLifeStatus(lifeStatus),
      selectedTheme,
      form: {
        petName: pet.petName || '',
